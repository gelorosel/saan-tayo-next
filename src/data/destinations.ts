...
export const destinations: Destination[] = [
  ...
  {
    id: "visayas-mtn-mt-panay",
    name: "Mt. Panay Trilogy",
    overrideUnsplashName: "mountains panay", // "trilogy" fetches unwanted photos
    island: "visayas",
    environments: ["mountains"],
    activities: ["hike", "natural_wonders"],
    bestSeasons: ["cool_dry"],
  ...
  },
  {
    ...
    island: "luzon",
    environments: ["beach"],
    activities: ["swim", "relax", "explore", "hike", "snorkel"],
    bestSeasons: ["cool_dry", "hot_dry"],
    location: { region: "Batangas" },
  },
